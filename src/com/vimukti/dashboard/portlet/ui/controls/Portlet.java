...
import com.vimukti.dashboard.chart.ui.controls.ChartSettingsDialog;
...
public class Portlet extends FlowPanel implements DropHandler, DragHandler,
		RequiresResize {
	...
	private void createHeaderBarForPortlet() {
		...
		settings.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				ChartSettingsDialog componentEditor = new ChartSettingsDialog(
						component);
			}
		});
	...
	class ChartContainer extends FlowPanel implements IDroppable {
		...
		public void createChartPanel() {
			...
			if (component == null) {
				...
				icon.addStyleName(component.getComponentType().toString()
						.toLowerCase()
						+ "-icon");
